                            ...
                            <tbody>
                                ...
                                if ($select_products->rowCount() > 0) {
                                    ...
                                    while ($fetch_products = $select_products->fetch(PDO::FETCH_ASSOC)) {
                                        $cat_id = $fetch_products['category_id'];
                                        $select_cat = $conn->prepare("SELECT title FROM `tbl_category` where id=?");
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td><img src="uploaded_img/<?= $fetch_products['image']; ?>" width="70" height="70"> </td>
                                            <td>
                                                <a href="product_update.php?update=<?= $fetch_products['id']; ?>" class=" btn btn-success">
                                                    <i class="fa fa-pencil"></i>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="product_delete.php?delete=<?= $fetch_products['id']; ?>" class=" btn btn-danger">
